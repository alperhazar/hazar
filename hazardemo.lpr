...
var
  Mode: Char;
  Rounds: Integer;
  InputFile, OutputFile, Password: string;
...
begin
  ...
  begin
    ...
    if EncryptFile(InputFile, OutputFile, Password) then
      WriteLn('OK')
    else
    begin
  ...
  begin
    ...
    if DecryptFile(InputFile, OutputFile, Password) then
      WriteLn('OK')
    else
    begin
  ...
  begin
    ...
    if SecureDelete(InputFile, Rounds) then
